...
export const SPORT_101_CONTENT: Record<string, Sport101Content> = {
  soccer: {
    ...
    keySkills: ['Spatial awareness', 'Team communication', 'Lower body strength', 'Endurance', 'Quick decision-making'],
    equipment: [
    ...
    commonInjuries: [
      { injury: 'Ankle sprains', prevention: 'Proper warm-up, ankle strengthening exercises, appropriate footwear', recovery: '2-4 weeks for mild strain' },
      { injury: 'Knee injuries', prevention: 'Proper technique, core strengthening, hamstring flexibility', recovery: '4-8 weeks' },
      { injury: 'Head trauma', prevention: 'Proper heading technique (start teaching at age 10+), neck strengthening', recovery: 'Weeks to months' }
    ],
    costs: {
    ...
    collegeOpportunity: { percentReachCollege: 2, scholarshipsAvailable: true, investmentToReachCollege: '$15,000-30,000/year' },
    parentRating: 4.6,
  ...
  basketball: {
    ...
    keySkills: ['Hand-eye coordination', 'Jumping ability', 'Court awareness', 'Passing and shooting', 'Quick footwork'],
    equipment: [
    ...
    commonInjuries: [
      { injury: 'Ankle sprains', prevention: 'Proper warm-up, ankle taping, appropriate footwear with ankle support', recovery: '1-3 weeks for mild strain' },
      { injury: 'Knee injuries', prevention: 'Proper landing technique, core strengthening, hamstring flexibility', recovery: '2-6 weeks' },
      { injury: 'Finger/hand injuries', prevention: 'Proper catching technique, finger taping if needed', recovery: '1-2 weeks' }
    ],
    costs: {
    ...
    collegeOpportunity: { percentReachCollege: 1.5, scholarshipsAvailable: true, investmentToReachCollege: '$12,000-25,000/year' },
    parentRating: 4.5,
  ...
  swimming: {
    ...
    keySkills: ['Cardiovascular endurance', 'Muscle strength', 'Breath control', 'Coordination', 'Discipline'],
    equipment: [
    ...
    commonInjuries: [
      { injury: 'Shoulder impingement', prevention: 'Proper stroke technique, shoulder strengthening, adequate recovery', recovery: '2-4 weeks' },
      { injury: 'Knee pain', prevention: 'Proper kicking technique, flexibility work, core strength', recovery: '1-3 weeks' },
      { injury: 'Ear infections', prevention: 'Dry ears after swimming, use earplugs if prone', recovery: '1-2 weeks with treatment' }
    ],
    costs: {
    ...
    collegeOpportunity: { percentReachCollege: 3, scholarshipsAvailable: true, investmentToReachCollege: '$15,000-35,000/year' },
    parentRating: 4.7,
  ...
  tennis: {
    ...
    keySkills: ['Hand-eye coordination', 'Quick footwork', 'Strategic thinking', 'Agility', 'Mental focus'],
    equipment: [
    ...
    commonInjuries: [
      { injury: 'Tennis elbow', prevention: 'Proper racket grip size, technique coaching, gradual increase in play', recovery: '2-6 weeks' },
      { injury: 'Ankle sprains', prevention: 'Proper footwork, ankle strengthening, good court shoes', recovery: '1-3 weeks' },
      { injury: 'Shoulder strain', prevention: 'Proper serve technique, shoulder strengthening, adequate rest', recovery: '2-4 weeks' }
    ],
    costs: {
      recreational: '$100-250/month',
    ...
    collegeOpportunity: { percentReachCollege: 2.5, scholarshipsAvailable: true, investmentToReachCollege: '$12,000-28,000/year' },
    parentRating: 4.4,
  ...
  gymnastics: {
    ...
    keySkills: ['Strength and flexibility', 'Body awareness', 'Balance', 'Courage', 'Coordination'],
    equipment: [
    ...
    commonInjuries: [
      { injury: 'Wrist sprains', prevention: 'Proper warm-up, wrist strengthening, gradual skill progression', recovery: '2-4 weeks' },
      { injury: 'Ankle sprains', prevention: 'Ankle strengthening exercises, proper landing technique', recovery: '1-3 weeks' },
      { injury: 'Back strain', prevention: 'Core strengthening, flexibility work, proper technique', recovery: '2-6 weeks' }
    ],
    costs: {
    ...
    collegeOpportunity: { percentReachCollege: 2, scholarshipsAvailable: true, investmentToReachCollege: '$20,000-40,000/year' },
    parentRating: 4.8,
