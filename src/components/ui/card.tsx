...
>(({ className = '', ...props }, ref) => (
  <div
    ref={ref}
    className={`flex flex-col space-y-1.5 border-b border-gray-200 dark:border-gray-700 p-6 ${className}`}
    {...props}
  />
));
...
>(({ className = '', ...props }, ref) => (
  <div
    ref={ref}
    className={`flex items-center border-t border-gray-200 dark:border-gray-700 p-6 pt-0 ${className}`}
    {...props}
  />
));
